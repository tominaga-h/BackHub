...
1. `gh issue view N -R tominaga-h/BackHub` を実行し、Issue の内容を取得する
...
→ `gh issue view 13 -R tominaga-h/BackHub` で Issue 内容を取得し、プランモードで実装計画を提示、承認後に実装、完了後に Issue をクローズする。
